...
const Footer: React.FC<FooterProps> = ({ items }) => {
  return (
    <footer className="w-full py-6 bg-black backdrop:blur-md z-50 bg-Bl border border-white dark:border-white/[0.2] text-gray-400 p-4 rounded-lg  flex flex-col items-center">
